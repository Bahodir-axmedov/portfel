 ...
 * `name?: string` attribute. A plain intersection would collapse our
 * `string | null` back down to `string | undefined`, so the inherited
 * `name` is removed first and then redeclared.
 */
