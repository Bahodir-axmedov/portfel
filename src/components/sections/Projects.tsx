...
export async function Projects({
	...
	return (
		<Section id="projects" className="isolate">
			{/* Depth layer, mirrored to the opposite side of the About orb so the
			    page does not read as one repeated background. */}
			<Parallax
				distance={60}
			...
			>
				<span
					aria-hidden
					className="block h-[360px] w-[min(560px,88vw)] rounded-full bg-gradient-to-br from-accent-500 to-violet-500 opacity-[0.06] blur-[120px]"
				/>
			</Parallax>
