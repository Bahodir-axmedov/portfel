...
export async function About({
	...
	return (
		<Section id="about" className="isolate">
			{/* Depth layer. `isolate` on the section keeps the negative z-index
			    inside this stacking context, so the orb sits under the content but
			...
			>
				<span
					aria-hidden
					className="block h-[380px] w-[min(660px,92vw)] rounded-full bg-brand-gradient opacity-[0.07] blur-[120px]"
				/>
			</Parallax>
			...
			<Container>
				...
				<div className="mt-12 grid gap-6 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
					{/* Narrative */}
					<Reveal variant={slideLeft} className="flex flex-col gap-6">
