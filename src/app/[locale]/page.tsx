...
export default async function HomePage({
	...
	/* Floating chips around the portrait. Sorted by proficiency and capped at
	   eight, which is exactly the number of hand-placed anchors the Hero owns:
	   passing more would silently drop them, passing fewer simply leaves anchors
	   empty. They always advertise the strongest part of the real skill set
